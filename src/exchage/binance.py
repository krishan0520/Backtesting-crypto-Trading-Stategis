...
class BinannceClient:
    def __init__(self,futures=False):
        self.furures = futures  
    ...
    def _get_symbols(self):
        params = dict()
        endpoint = "/fapi/v1/exchangeInfo" if self.furures else "/api/v3/exchangeInfo"
    ...
    def get_historical_data(self,symbol:str,start_time: Optional[int]=None,end_time: Optional[int]=None):
        ...
        endpoint = "/fapi/v1/klines" if self.furures else  "/api/v3/klines"
